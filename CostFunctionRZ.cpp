...
void CostFunctionRZ::initialize(const real& imin, const real& imax, const int& idim,
...
void CostFunctionRZ::calcInnovation()
{
...
void CostFunctionRZ::calcHTranspose(const real* yhat, real* Astate) 
{
...
bool CostFunctionRZ::SAtransform(real* Bstate, real* Astate)
{
	int k;
	for (int var = 0; var < varDim; var++) {
...
void CostFunctionRZ::SBtransform(real* Ustate, real* Bstate)
{
	// Clear the Bstate
	for (int var = 0; var < varDim; var++) {
		for (int iIndex = 0; iIndex < iDim; iIndex++) {
...
void CostFunctionRZ::SBtranspose(real* Bstate, real* Ustate)
{
...
void CostFunctionRZ::SCtransform(real* Astate, real* Cstate)
{
...
void CostFunctionRZ::SCtranspose(real* Cstate, real* Astate)
{
...
bool CostFunctionRZ::setupSplines()
{
...
bool CostFunctionRZ::outputAnalysis(const QString& suffix, real* Astate, bool updateMish)
{
...
// Basis Functions
float CostFunctionRZ::BasisOri(int m, float x, int M, float xmin, 
...
float CostFunctionRZ::DBasisOri(int m, float x, int M, float xmin, 
								 float DX, float DXrecip, int C)
{
	float b = 0;
	float xm = xmin + (m * DX);
...
float CostFunctionRZ::DDBasisOri(int m, float x, int M, float xmin, 
								  float DX, float DXrecip, int C)
{
	float b = 0;
	float xm = xmin + (m * DX);
...
float CostFunctionRZ::DDDBasisOri(int m, float x, int M, float xmin, 
								   float DX, float DXrecip, int C)
{
	float b = 0;
	float xm = xmin + (m * DX);
...
real CostFunctionRZ::Basis(int m, real x, int M, real xmin, 
