...
$lat_origin = 18; # Latitude of reference frame at origin time
$lon_origin = 150;  # Longitude of reference frame at origin time
$u = -4.0; # U storm motion (m/s)
$v =  0.0; # V storm motion (m/s)
...
$origintime = 14400; # Time when the frame is at the lat and lon origin in seconds from initial HMS
