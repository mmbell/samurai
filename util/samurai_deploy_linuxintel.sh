...
chmod 444 lib/*
rm samurai_v1.0.0-RC1_linux.tar.bz2
tar -cjvf samurai_v1.0.0-RC1_linux.tar.bz2 bin/ lib/ util/ecgrads2bg.pl util/samurai_out2bg.pl util/samurai_lineartrack.pl doc/ 
